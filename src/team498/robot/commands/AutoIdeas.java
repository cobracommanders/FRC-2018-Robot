...
public class AutoIdeas extends CommandGroup {
    ...
    public AutoIdeas() {
	    	...
	    	/**
	    	 ...
	    	 5. addSequential of driving around to the back of the switch for x seconds
	    	 6. addSequential of grabbing a cube
	    	 7. addSequential of positioning in front of the scale
	    	 8. addSequential of throwing the cube on the scale 
	    	 9. addSequential of turning around for x seconds 
	    	 10. addSequential of driving forward to the front of switch for x seconds
	    	 11. addSequential of turning right for x seconds
	    	 12. addSequential of driving forward for x seconds
	    	 13. addSequential of grabbing a cube 
	    	 14. addSequential of driving back to the exchange wall for x seconds 
	    	 */
